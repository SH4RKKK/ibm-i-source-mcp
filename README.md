...
[search_source: 44.1s, 61 live progress update(s) streamed]
    0.2s  listing members in ATR001LIB/SOURCE
    0.9s  scanning 3958 member(s) in ATR001LIB/SOURCE for "afdeling"
   43.8s  scanning SOURCE(LOTYAFBRSR), 60 match(es) so far (178/3958)
   44.0s  search for "afdeling" in ATR001LIB: 60 match(es) across 3958 member(s)
```
